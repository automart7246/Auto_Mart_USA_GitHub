//Found Method to Replace URL Pattern from Manheim Details Webpage with my Copy Webpage
    ...
    items.each(function() {$(this).attr('href', $(this).attr('href').replace('https://members.manheim.com/members/results#', 'https://kotr9001.github.io/Auto_Mart_USA_GitHub/Auto_Mart_USA_PowerSearch_Page/members/results.html#'))});
    ...
    advanced_search.attr('href', advanced_search.attr('href').replace('https://members.manheim.com/members/advancedSearch', 'https://kotr9001.github.io/Auto_Mart_USA_GitHub/Auto_Mart_USA_AdvancedSearch_Page/members/advancedSearch.html#'));