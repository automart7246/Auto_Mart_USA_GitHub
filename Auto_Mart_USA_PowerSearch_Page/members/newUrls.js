//Found Method to Replace URL Pattern from Manheim Details Webpage with my Copy Webpage
    ...
    $('div.uhf-responsive > header > div.uhf-menu--primary uhf-menu--offscreen uhf-accordion > div.uhf-panel--buy uhf-accordion__section > div.uhf-accordion__panel > div.uhf-accordion__panel__drawer > div.uhf-menu__group uhf-menu__group--1 > div.uhf-menu__category > ul.uhf-menu__category__items > li.uhf-menu__category__item a').each(function(){
      $(this).attr('href', $(this).replace('https://members.manheim.com/members/results#', 'file:///C:/Users/bjros/OneDrive/Desktop/Projects/Auto_Mart_USA_GitHub/Auto_Mart_USA_PowerSearch_Page/members/results.html#'));
    });
    ...
    items.each(function() {$(this).attr('href', $(this).attr('href').replace('https://members.manheim.com/members/results#', 'file:///C:/Users/bjros/OneDrive/Desktop/Projects/Auto_Mart_USA_GitHub/Auto_Mart_USA_PowerSearch_Page/members/results.html#'))});
    ...
    advanced_search.attr('href', advanced_search.attr('href').replace('https://members.manheim.com/members/advancedSearch', 'file:///C:/Users/bjros/OneDrive/Desktop/Projects/Auto_Mart_USA_GitHub/Auto_Mart_USA_AdvancedSearch_Page/members/advancedSearch.html'));